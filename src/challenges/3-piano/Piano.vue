<template>
  <section class="flex items-center justify-center h-screen p-8 bg-cyan-600">
    <svg
      width="1387"
      height="467"
...
const blackKeyPaths: string[] = [
  ...
  "M1286.92 279.16L1232.57 273.722L1241.22 1.50762L1284.47 5.83491L1286.92 279.16Z",
...
function handleKeyClick(keyIndex: number): void {
  const audioUrl = new URL(`./audio/key-${keyIndex}.mp3`, import.meta.url).href;
